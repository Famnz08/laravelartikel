...
<body>
        ...
        <section class="about-section text-center" id="tentang">
            <div class="container px-4 px-lg-5">
                ...
                <img class="img-fluid" src="assets/img/pisang1.jpeg" alt="..." />
            </div>
        </section>
<div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                        ...
                        <!-- /.col -->
                        <form class="form-horizontal" action="pisang/store" method="POST">
                      @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName2" placeholder="name" name="name" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Comment</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" class="comment" placeholder="Comment" name="comment" required>
                        </div>
                      </div>
                      <div class="form-group row">
